...
figure;
plot(sampleNumVectorLow,rectifiedLowChannel);
xlabel('Sample Number');
ylabel('Lowest Frequency Signal Amplitude - Rectified');

figure;
plot(sampleNumVectorHigh,rectifiedHighChannel);
xlabel('Sample Number');
ylabel('Highest Frequency Signal Amplitude - Rectified');
...
% MATLAB Code
% Generated by MATLAB(R) 9.12 and Signal Processing Toolbox 9.0.
% Generated on: 17-Jul-2022 00:44:40
